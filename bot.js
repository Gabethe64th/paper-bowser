...
bot.on('message', message=> {
    ...
    switch(args[0]){
        ...
        case 'report':
            ...
            case 'pair':
                if (message.mentions.users.first(1) != undefined){
                    message.channel.send("*Reading the pair scores of "+message.mentions.users.first().username+" and "+message.mentions.users.first(1).username+"...*")
