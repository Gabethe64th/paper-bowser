...
var word1 = ["You", "Name", "Dru", "Irri", "Poochy", "Jet", "Mario", "Luigi", "Reun", "Cain", "Sayori", "Ghost", "Yuri", "Knux", "Y'all", "Sonic", "Minecraft", "Ellie", "Sushi", "Izzle", "Moon", message.author.username];
var word2 = ["is", "is gonna be", "is about to be", "is thinking of", "wants to be", "is officially"];
...
var word4 = ["h", "you", "Raid Shadow Legends", "Name", "Dru", "Irri", "Poochy", "Jet", "Mario", "Luigi", "Reun", "Cain", "Sayori", "Ghost", "Yuri", "Knux", "Y'all", "Sonic", "Minecraft", "me", "gay", "appropriate", "Spider-Man", "here", "Celeste", "a hat in time", "a perv", "Squidward", "communism", "Ellie", "Sushi", "Izzle", "Moon", message.author.username, "Moon's oddly advertised dick", "Ellie's will to be a god", "Dru, but not really", "Izzle, and Gabe agrees", "Virus, but Virus doesn't care", "Dys, but thank god he's gone", "Earthbound", "Gabe, and he hates you for that", "Monika, but she refuses", "Monika, who sang a song for them", "Nutella, but that's gay", "a gay guy", "a freaking bag", "Generic", "Jet, but she'll most likely sue you before it happens", "Name, but that's a crime", "Dru, but [sexual joke here]", "Barry...wait. Who's Barry?", "a loli", "Snoop, who screams during the event", "Arrowsen, but it didnt work", "Link, the princess"];
