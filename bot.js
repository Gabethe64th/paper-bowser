...
bot.on('message', message=> {
    ...
    switch(args[0]){
        ...
        case 'v3':
            message.channel.send("This command seems to be broken. Try again another time?")
        break;
        ...
        case 'HappyBirthdayMoon':
            message.channel.send("Clean up the confetti! This command was fun, but now it's time to say goodbye. The command still exists, but its code will be used for something else. (v!shitpostStatus) Thanks for the support!")
            break;
        ...
        case 'v2announce':
            message.channel.send("**It's been 2 years, huh?** \n \nFrom calls, to images, to wacky personal commands, VirusBot survived for...way longer than I expected, lmao.\nOf course, from the bottom of my heart, THANK **YOU** for the support of my personal project! It's been fun! Really fun to learn a lot about discord bots and human interaction with it. And I'm glad to have made a fun-ish time killer for you guys on this server, and your own personal servers.\nSo yes, to you all, thanks for dealing with my bullshit, lmao. It's been a fun experiment.\n \n...but all good things must come to an end, sadly...sorta. \nI think it's been obvious that I've been too busy with other things to be constantly keeping an eye on this bot, and while I do appreciate the wake-up calls and pings, the hype I had for this bot kinda...died for me. \nSo, to put it bluntly, **VirusBot will have no more major updates/commands.** This won't be I'm dropping support, however, I'll still make personal commands (once requested) and update existing ones. As well as the occasional bug fixing when any are found. But yeah, I'm kinda done making more big commands for Virus rn. \n \nBut hey! It ain't over...not yet at least. I have an idea for something. Something that's like a revamped version of the cancelled QOL update. And once that's released...sadly that'll be the end of VB support. You'll still be able to use it, of course! But I'll be done looking at it. \n \nSo uhm...yeah. Thank you all so much for the amazing two years! And I do hope the last big feature I'm working on will be an amazing last hurrah for the bot! But it's gonna take a long while, so until then, stay tuned! \n \n*And keep being on the lookout for secrets. Hehe...* \n \nHappy Anniversary, Virus! :tada:")
        break;
        ...
        case 'oldie':
           ...
           case 'dedmeme':
            ...
            case 'call':
                ...
                else if (bot.channels.cache.get(callids[callB]) == undefined){
                    message.channel.send("**Hmm, there's nothing but static here. Try again?** \n`Call ID:"+callids[callB]+"`")
                }
                else {
        ...
        case 'mimik':
            message.channel.send("[ARCHIVED, See 'v!reni'] \nSome Pokemon who dislikes off-topic in rp. \n\n**Example:** \nArrow: (no, don't no that.) \nMimik: You've fucking crossed the line.");
            break;
        ...
        case 'phobos':
            message.channel.send("[ARCHIVED, See 'v!jet'] \nSome weird clone that took over Jet some time ago. The difference between these two is that one wants to kill you less than the other (Also some other noticeable things, but I can't say them rn.). \n\n**Example:** \nSnoop: Hello. \nJet: Fuck off. \n\n**One week later...**\nSnoop: Hello. \nPho: Hi, Snoop. Now fuck off.")
            break;
        ...
        case 'ender':
            message.channel.send("Ozzy's rival with no context. \n\n**Example:** \nDid Ender defeat that cuphead boss yet?")
            break;
        ...
        case 'kaden':
            message.channel.send("1. An underpaid employee from Ina's cafe. Wait, nevermind, they're the only employee. \n2. A tech guy who you would be glad to meet as a friend. \n3. One hairy monke\n\n**Example:** \nKADEN, INA'S CAFE IS OPEN! No rush, though. <3")
            break;
            ...
            .setAuthor("Requested by "+message.author.username, message.author.avatarURL())
                ...
                bot.users.cache.get(message.author.id).send(embed3);
                    ...
                    .setAuthor("Requested by "+message.author.username, message.author.avatarURL())
                        ...
                        .addField('The following quotes are user-specific:', '• owo - Only Ozzy and Moon can use this.\n• Drizzle - Only Jet can use this.\n• Joe - Only Reun can use this.')
                        .addField('\u200b', '\u200b')
