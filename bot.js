...
var activitylist = ["lmao who's Corona? They suck.", "around", "as Steve", "Hello, Jet :)", "rootin' tootin' and shootin'", "Did you vaccinate yet?", "Full of typos since 2019!", "The Ded Name Master.", "9+ with Knux", "You either bipolar or bisexual. I'm binary.", "v!help (Or v!commands for ACTUAL help.)", "as a broken YouTube player", "say 'Hello There', I dare you.", "Anyone remember v!o64?", "Minecraft", "Sonic Mania", "Celeste", "Among Us", "Madness Combat (Goated)", "A Hat In Time", "In...a few servers", "Go, Man, Go!", "Is Gabe sleeping again?!", "v!oldies STILL doesn't work!", "New episodes every Sunday!", "Good Morning...or not. Was never programmed with a clock.", "Still Alive.", "Super Mario 64", "big iron on his hip."]
